"""
Django settings for SmartGroceryApp project.
...
SECRET_KEY = 'django-insecure-yfh5d%xc9go*=i^sui@ks097&kx3h_n1sq^q*gqrjtc4x*vevb'
...
ROOT_URLCONF = 'SmartGroceryApp.urls'
...
WSGI_APPLICATION = 'SmartGroceryApp.wsgi.application'
